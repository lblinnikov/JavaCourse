...
public class LineCrosser {
    public static void main(String[] args){
        ...
        // Reads two couples of coordinates x1, y1 and x2, y2 and writes out an x coordinate of a point, where the line going through (x1, y1) and (x2, y2) crosses the X axis (y=0).
        ...
        // TODO catch when x2-x1 is ZERO ? possible with branching
